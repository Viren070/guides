...
<StremioAddonButtons id="jackettio" manifest="https://jackettio.elfhosted.com/manifest.json" configurable={true} configurationRequired={true} configureAtBase={false} source="https://github.com/arvida42/jackettio"/> 

...
<AddonLinks id="annatar" manifest="https://annatar.elfhosted.com/manifest.json" configurable={true} configurationRequired={true} source="https://github.com/g0ldyy/annatar"/> 

...
<StremioAddonButtons id="knightcrawler" manifest="https://knightcrawler.elfhosted.com/manifest.json" configurable={true} configurationRequired={false} source="https://github.com/knightcrawler-stremio/knightcrawler"/> 

[KnightCrawler](https://github.com/knightcrawler-stremio/knightcrawler) is a fork of [Torrentio](addons?addon=torrentio).

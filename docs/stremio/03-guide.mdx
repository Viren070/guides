...
I will now go through some Anime addons. A reminder that these addons are only catalogue addons and do not provide any links themselves. 
However, Torrentio with the NyaaSi provider enabled should provide you the necessary links. 
...
:::warning
You can only create up to 4 lists with a free account. If you want to create more lists, you will need to [become a supporter](https://docs.mdblist.com/docs/supporter/).
:::
...
### Trakt Up Next Addon
:::note
This addon is currently down, I will write the instructions for it in case it comes back up.
::: 
...
To set this up: 
1. Head over to the [Trakt Up Next Configuration page](https://2ecbbd610840-trakt-up-next.baby-beamup.club/configure)

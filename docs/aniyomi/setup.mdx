...
Aniyomi is not available on the Google Play Store, so you'll need to download it from the [official website](https://aniyomi.com/).


1. Go to the [downloads page](https://aniyomi.com/download) on the Aniyomi website.

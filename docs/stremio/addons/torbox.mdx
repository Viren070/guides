...
tags: [stremio-addon:torrent-streams, stremio-addon:usenet-streams]
---
...
4. Scroll down to the `Integration Settings`. 
    ![Integration Settings](/img/stremio/torbox_integration_settings.png)
...
7. Once the addon has been installed, you can go back to the `Integration Settings`. 
   You should now see configuration options for the Torbox addon.
    ![Torbox Configuration](/img/stremio/torbox_stremio_settings.png)

...
<AddonLinks id="jamovies" manifest="https://eja-addon.vercel.app/manifest.json" configurable={true} configurationRequired={false} configureAtBase={false} source="https://github.com/ejatapibeda/JaMovies/"/> 

...
Now that you have the link, open Stremio, go to the addons page and either click the `+ Add addon` button (if the button is there) and paste the URL in or paste the link into the search bar.
...
#### Torrent/Debrid Addons

I will first go through the torrent addons. These addons are better as they provide a larger library of content and of higher quality than those available through http streams.

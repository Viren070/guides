...
<AddonLinks id="anime-catalogs" manifest="https://1fe84bc728af-stremio-anime-catalogs.baby-beamup.club/manifest.json" configurable={true} configurationRequired={true}/> 

...
<AddonTemplate id="jackettio" manifest="https://jackettio.elfhosted.com/manifest.json" configurable={true} configurationRequired={false} configureAtBase={false} source="https://github.com/arvida42/jackettio"/> 

...
Do consider using my affiliate links to sign up if you haven't created an account already. These are available [here](guide#which-debrid-service-do-i-use).
:::
...
2. Click the ` + Add Addon` button in the top right corner. 
...
This is for if you are using the Stremio app on a device such as Android, Windows, macOS etc. 
...
- [Simkl addon](https://stremio-simkl.nktfh100.com/)

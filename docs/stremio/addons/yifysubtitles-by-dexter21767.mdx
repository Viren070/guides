...
---
import AddonButtons from '@site/src/components/StremioAddonButtons';

<AddonButtons id="yifysubtitles-by-dexter21767" manifest="https://2ecbbd610840-yifysubtitles.baby-beamup.club/manifest.json" configurable={true} configurationRequired={true}/> 

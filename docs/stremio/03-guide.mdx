...
<TabItem value="web" label="Web" default>
    ...
    <TabItem value="web-ios" label="iOS">
        ...
        To work around this limitation, you could setup a streaming server on your android phone or desktop. However, this may be inconvenient as you may not have an android phone or you may not want to leave your desktop on 24/7.
        ...
        To overcome these limitations, you can use an android phone or desktop as a server. To do this, follow the instructions in the [Stremio Server](extras/stremio-server) section.

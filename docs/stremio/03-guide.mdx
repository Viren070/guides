...
[Stremio Web](https://web.stremio.com/) is a web version of Stremio that can be accessed on any device with a web browser. It requires no installation. 
However, Stremio service is a companion to Stremio Web and is required for some features. Stremio Service will become the server for Stremio Web. 
...
You will need to use the manual method of adding addons through a link.
:::
...
<summary>IMDB Catalogs</summary>
    ...
    [Direct Install Link](stremio://1fe84bc728af-imdb-catalogs.baby-beamup.club/manifest.json).
...
<summary>Kitsu</summary>
    ...
    [Direct Install Link](stremio://anime-kitsu.strem.fun/manifest.json)

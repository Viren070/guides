...
<TabItem value="ios" label="iPhone / iPad">
    ...
    **Installing Stremio Web**
    ...
    To enjoy full functionality, including torrent streaming, progress tracking, and subtitles, follow the steps in the [Setting up Stremio Service](#setting-up-stremio-service) section.

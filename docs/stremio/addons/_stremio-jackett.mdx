...
<AddonLinks id="stremio-jackett" manifest="https://stremio-jackett.elfhosted.com/manifest.json" configurable={true} source="https://github.com/aymene69/stremio-jackett" /> 

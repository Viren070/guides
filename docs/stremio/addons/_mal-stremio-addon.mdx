...
<AddonTemplate id="mal-stremio-addon" manifest="https://mal-stremio.vercel.app/manifest.json" configurable={true} configurationRequired={true} source="https://github.com/SageTendo/mal-stremio-addon"/> 

...
<AddonTemplate id="cyberflix" manifest="https://cyberflix.elfhosted.com/manifest.json" configurable={true} configurationRequired={true} source="https://github.com/marcojoao/cyberflix-server"/> 

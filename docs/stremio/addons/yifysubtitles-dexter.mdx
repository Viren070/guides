...
<StremioAddonButtons id="yifysubtitles-dexter" manifest="https://2ecbbd610840-yifysubtitles.baby-beamup.club/manifest.json" configurable={true} configurationRequired={true}/> 

...
<TabItem value="ios" label="iPhone / iPad">
    ...
    **Installing Stremio Web**
    ...
    - Addon-provided subtitles cannot be used.
    ...
    To enjoy full functionality, including torrent streaming, progress tracking, and subtitles, follow the steps in the Web tab. 

...
<AddonLinks id="comet" manifest="https://comet.elfhosted.com/manifest.json" configurable={true} configurationRequired={true} source="https://github.com/g0ldyy/comet"/> 

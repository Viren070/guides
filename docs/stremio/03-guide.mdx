...
If you are using Stremio Web, click on the Stremio Web tab below.  
...
Stremio service is a companion to Stremio Web and is required for some features. Stremio Service will become the server for Stremio Web. 
...
:::info 
If you are going to be torrenting (using torrent addons without a debrid service), then set the torrent profile to Ultra Fast and the cache size to 10GB or infinite. 
:::
...
<TabItem value="ios" label="iOS">
    ...
    Follow the Stremio Web tab to set up the Stremio service. Follow this on a desktop device. 

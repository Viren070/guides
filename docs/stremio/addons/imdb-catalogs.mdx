...
<StremioAddonButtons id="imdb-catalogs" manifest="https://1fe84bc728af-imdb-catalogs.baby-beamup.club/manifest.json" configurable={true} configurationRequired={false} configureAtBase={false}/> 
...
2. Enter your RPDB API key after [obtaining one](faq#how-do-i-obtain-a-rpdb-api-key)
3. Click Load 

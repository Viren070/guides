...
<AddonLinks id="tmdb-addon" manifest="https://94c8cb9f702d-tmdb-addon.baby-beamup.club/manifest.json" configurable={true} source="https://github.com/mrcanelas/tmdb-addon" /> 

---
title: Annatar
description: A fast torrent search addon that requires a debrid service.
keywords: [stremio, addons, addon, annatar, torrent, guide, setup, configuration, install, link]
...
[Annatar](https://github.com/g0ldyy/annatar) is a self hostable and fast torrent/debrid search addon.

...
tags: [stremio-addon:torrent-streams, stremio-addon:sports]
---

import StremioAddonButtons from '@site/src/components/StremioAddonButtons';

<StremioAddonButtons id="formulio" manifest="https://formulio.hayd.uk/manifest.json" configurable={true} configurationRequired={false} configureAtBase={true} source="https://github.com/TheRaceDirector/formuliodev/"/> 

Formulio is a Stremio addon that focuses on Formula One and MotoGP content. 

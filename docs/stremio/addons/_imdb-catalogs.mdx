...
<AddonLinks id="imdb-catalogs" manifest="https://1fe84bc728af-imdb-catalogs.baby-beamup.club/manifest.json" configurable={true} configurationRequired={false} configureAtBase={false}/> 
